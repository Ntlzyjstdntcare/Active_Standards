...
public class CronDSL 
{
    ...
    /**
    * Constructor for CronDSL instances.
    * <p>
    * Creates new CronDSL instance with class variables initialised
    * to the values specified in the parameters to the CronConstructor
    * setter methods.
    * </p> 
    */
    private CronDSL(CronDSLConstructor c) 
    {
        seconds = c.seconds;
        minutes = c.minutes;
        hours = c.hours;
    ...
    /**
    * Inner class for building CronDSL Objects. 
    * <p>
    * Allows us to create a CronDSL object, with the class variables
    * set by the parameters to the setter methods of the inner class.
    * </p>
    */
    static class CronDSLConstructor 
    {      
        ...
        */
        public CronDSLConstructor() {}
     
        /**
        * Setter method for seconds value of CronDSL.
        * <p>
        ...
        * </p>
        * @param String value that the user wishes to set for the CronDSL seconds field.
        * @return a CronDSLConstructor instance with the value for the seconds field updated.
        */
        public CronDSLConstructor secondsAre(String seconds) 
        {
            String s = seconds;
        ...
        /**
        * Setter method for minutes value of CronDSL.
        * @param String value that the user wishes to set for the CronDSL minutes field.
        * @return a CronDSLConstructor instance with the value for the minutes field updated.
        */
        public CronDSLConstructor minutesAre(String minutes) 
        {
            String m = minutes;
            boolean validChar = true;
        ...
        /**
        * Setter method for hours value of CronDSL.
        * @param String value that the user wishes to set for the CronDSL hours field.
        * @return a CronDSLConstructor instance with the value for the hours field updated.
        */
        public CronDSLConstructor hoursAre(String hours)  
        {
            String h = hours;
            boolean validChar = true;
        ...
        /**
        * Setter method for day of month value of CronDSL.
        * @param String value that the user wishes to set for the CronDSL day of month field.
        * @return a CronDSLConstructor instance with the value for the day of month field updated.
        */
        public CronDSLConstructor daysOfMonthAre(String dayOfMonth)  
        {
        ...
        /**
        * Setter method for months value of CronDSL.
        * @param String value that the user wishes to set for the CronDSL months field.
        * @return a CronDSLConstructor instance with the value for the months field updated.
        */
        public CronDSLConstructor monthsAre(String month)  
        {
            String mth = month;
            boolean validChar = true;
        ...
        /**
        * Setter method for day of week value of CronDSL.
        * @param String value that the user wishes to set for the CronDSL day of week field.
        * @return a CronDSLConstructor instance with the value for the day of week field updated.
        */
        public CronDSLConstructor daysOfWeekAre(String dayOfWeek)  
        {
            String dw = dayOfWeek;
            boolean validChar = true;
        ...
        /**
        * Setter method for year value of CronDSL.
        * @param String value that the user wishes to set for the CronDSL year field.
        * @return a CronDSLConstructor instance with the value for the year field updated.
        */
        public CronDSLConstructor yearsAre(String year)  
        {
            String y = year;
            boolean validChar = true;
        ...
        /**
        * Setter method for minutes value of CronDSL, in case the user wishes to leave the field empty.
        * @return a CronDSLConstructor instance with the value for the year field set to empty.
        */
        public CronDSLConstructor yearsAre()  
        {
            this.year = "";
            return this;
        }
        ...
        /**
        * This method returns a CronDSL instance with the class variables all set to the
        * values input as parameters to preceding CronDSLConstructor setter methods, assuming
        * that the user has used those methods.
        * @return a CronDSL instance.
        */
        public CronDSL construct() 
        {
            return new CronDSL(this);
        }
    } 
    ...
    */
    ...
    /**
    * Main method for creating our new CronDSL/cron string.
    */
    public static void main (String[] args)
    {
        CronDSL c = new CronDSL.CronDSLConstructor()
                         .secondsAre("3UNTIL45")
